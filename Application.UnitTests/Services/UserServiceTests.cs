...
namespace Application.UnitTests.Services
{
    public class UserServiceTests
    {
        ...
        public async Task UpdateAsync_ThrowsKeyNotFoundException_WhenUserDoesNotExist()
        {
            ...
            // Act & Assert
            await Assert.ThrowsAsync<KeyNotFoundException>(() => _userService.UpdateAsync(user, CancellationToken.None));
        }
        ...
        public async Task DeleteAsync_ReturnsFalse_WhenUserDoesNotExist()
        {
            ...
            // Act
            var result = await _userService.DeleteAsync(nonExistentId, CancellationToken.None);
